...
* 2021.9.27~10.10
    ...
    * [x] 初步实现可视化系统
        ...
        * [x] 实现论文召回的可视化
* 2021.10.11~10.17
    * [ ] 使用某个领域的学者论文引用数之和排序构造ground truth，重新训练GNN模型
        * 训练思路：（1）对于领域t召回论文，得到论文关联的学者集合，通过论文引用数之和构造学者排名；
...
* 2021.10.18~10.24
    ...
    * [ ] 推荐算法精排部分
        * [ ] 训练：构造学者排名ground truth，重新训练GNN模型
        * [ ] 预测：对于召回的论文构造子图，利用顶点表示向量计算查询词与学者的相似度，实现学者排名
    * [x] 写毕业论文
        * [x] 第二章 基础理论
