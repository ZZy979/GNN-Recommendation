...
* [x] 2021.9~2021.10 构造学术网络数据集，实现基于图神经网络的推荐算法
* [x] 2021.10~2021.11 整理实验结果，实现可视化系统，撰写毕业论文初稿
* [x] 2021.11~2021.12 完成毕业论文，准备毕业答辩
...
* [ ] CKE
* [ ] RippleNet
* [x] [KGCN](https://github.com/ZZy979/pytorch-tutorial/tree/master/kgrec/kgcn)
* [ ] KGAT
...
* 2021.11.8~11.21
    ...
    * [x] 完善毕业论文第三章实验部分
    * [x] 推荐算法精排部分
        * [x] 训练：目前的评价方式有问题，改为先召回论文再计算相关学者与领域的相似度（即与预测步骤相同）
            * [x] 训练论文召回GNN模型：连接预测，领域k和该领域top学者关联的该领域的论文之间的边是正样本
            * [x] 训练学者排名GNN模型：三元组损失
        * [x] 预测：对于召回的论文构造子图，利用顶点嵌入计算查询词与学者的相似度，实现学者排名（效果不好，需要继续优化）
* 2021.11.22~11.28
    * [x] 继续优化推荐算法中论文召回和学者排名的代码
    * [x] 完善毕业论文第四章实验部分，增加对比实验！！！
        * [x] 直接使用论文相似度求和
        * [x] KGCN
        * [ ] learn to rank
    * [x] 完成毕业论文终稿
