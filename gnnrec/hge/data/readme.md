...
## 字段分析
`python -m gnnrec.hge.data.oag.preprocess.analyze <type> <raw_path>`
...
## 第1步：抽取计算机领域的子集
`python -m gnnrec.hge.data.oag.preprocess.extract_cs <raw_path> <output_path>`
...
```python
from gnnrec.hge.data import OAGCSDataset
